...
class TravellerPage extends StatefulWidget{
  ...
  const TravellerPage({Key key, this.userProfile}) : super(key: key);


  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return TravellerPageState();
  }

}

class TravellerPageState extends State<TravellerPage>{
        ...
        actions: <Widget>[
          GestureDetector(
           ...
           child: Container(
               ...
               child: Center(
                 child: (widget.userProfile['Profile_pic']!=null)?CircleAvatar(
                   radius: 20.0,
                   backgroundImage: CachedNetworkImageProvider(widget.userProfile['Profile_pic']),
                 ):CircleAvatar(
                   radius: 20.0,
                   backgroundColor: Colors.black.withOpacity(0.4),
                   child: Center(
                     child: Text(widget.userProfile['Name'].toString().substring(0,1).toUpperCase(),
                       style: TextStyle(
                           color: Colors.white,
                           fontFamily: 'Montserrat'
                       ),),
